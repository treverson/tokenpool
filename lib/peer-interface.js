// RA - Ver 137 - Add STATIC DIFF PORTS - Mikers.
//
   ...
   async  handleValidShare( nonce,minerEthAddress,digest,difficulty, shareIsASolution, usingCustomDifficulty )
   {
      ...
      if(existingShare == null)
      {
        ...
        if( shareIsASolution )
        {
          ...
          //          client.loginWithToken('NDMyMTQ0NzMyMDI2ODMwODYw.DapFgg.UNu2MMcxeca2A7kdvnc2eH4Hrrw', output);
          ...
          //            }
          //          var channel = client.servers.get("Block-Bot", "0xBTCpool.com").updates;
          //          client.sendMessage(channel, "Woohoo, pool found a block!");
          // RA - END
        }else{
  ...
  async getAverageSolutionTime(minerAddress)
  {
   ...
   async getUpdatedVarDiffForMiner(minerData,minerAddress)
   {
      ...
      if( minerVarDiff > MAX_VARDIFF ){
           minerVarDiff = MID_VARDIFF;
      }
      if( minerVarDiff < MIN_VARDIFF ){
           minerVarDiff = MIN_VARDIFF;
      }
      ...
      // RA - Add hardcoded DIFF
            if(minerAddress.toString() == '0xCC675e6688255169eFfeC1b556730ba2479a9EA3'){
                     ...
                     minerVarDiff = 4096;
            } else if (minerAddress.toString() == '0x4e7fce45a17c4709A4eDEfE3b64CCAbEd225857d'){
                      minerVarDiff = 4096;
            } else if (minerAddress.toString() == '0xbd4Ae0dc3c0FA45e0119d3C108acDe1DaD5E7825'){
                      minerVarDiff = 8192;
  //          } else if (minerAddress.toString() == '0xF5e78d6B32F020690376806674AA92635cA56092'){
  //                    minerVarDiff = 1024;
            } else if (minerAddress.toString() == '0xAF1b929594BA515A699A25aBc29DA00F29723da0'){
                      minerVarDiff = 4096;
            } else if (minerAddress.toString() == '0xA804e933301AA2C919D3a9834082Cddda877C205'){
                     minerVarDiff = 4096;
            } else if (minerAddress.toString() == '0x3584EfbB3daB1D249c635e53305b1FBA77C723A5'){
                     minerVarDiff = 6144;
            } else if (minerAddress.toString() == '0x53a65913ed38d4537fb928bfcff03df00b8b26fd'){
                     minerVarDiff = 6144;
            } else if (minerAddress.toString() == '0x7A47501CbA5d028f374C4839329896f2ab4309c2'){
                     minerVarDiff = 6144;
            }
...
*/
   async checkMinedPayments(payment_txes)
   {
     ...
     for(i in payment_txes)
     {
      ...
      {
	      console.log('\n' )  // RA
	      console.log('************* 0xBTCpool - txData condifrmed' ) // RA
        continue;
      }
      console.log('\n' )
