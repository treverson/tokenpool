...
// RA - didn't - change from    var MAX_VARDIFF = 500000;
...
// RA - commented console logs below
      ...
      if(txDataJSON != null && txData.rewarded == true )
      {
        console.log('0xBTCpool test - Transaction already paid !')
        continue;
      }
...
//RA -       console.log('transferData',transferData)
...
//RA  - Added
        console.log('0xBTCpool - Making a payment !')
